...
// KHI TA CUNG CẤP TIỆN ÍCH CHO NƠI KHÁC XÀI , ĐÓ LÀ LÚC TA KO CẦN CNHOWS GÌ
...
public class MathUtil1 {
    ...
    // một cái ngoại lệ , chửi éo tính luôn
    ...
    public static long getFactorial(int n){
       ...
       if( n < 0 || n >20 )
        ...
        for ( int i = 2 ; i <= n; i++)
            product *= i ; // product = product đang có nhân con i , đập ngược trở về
